...
<div class="main-content-container container-fluid px-4">
    <!-- Page Header -->
    @include('layouts.pageheader.title', ['title' => 'จัดการอำเภอ', 'subtitle'=>'รายการอำเภอ'])
    <!-- End Page Header -->
            ...
            <table class="table table-hover table-bordered" id="tb-district">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="col-9 text-left tb-td">{{ $district->name }}</td>
                        <td class="col-2 text-right tb-td">
                            <a href="{{ route('admin.district.edit', ['id'=>$district->id]) }}"
                                class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="แก้ไข"><i
                                    class="far fa-edit"></i></a>
                            <a href="{{ route('admin.district.delete', ['id'=>$district->id]) }}"
