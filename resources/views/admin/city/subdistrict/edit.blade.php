...
<div class="main-content-container container-fluid px-4">
    <!-- Page Header -->
    @include('layouts.pageheader.title', ['title' => 'แก้ไขตำบล'])
    <!-- End Page Header -->
    ...
    <div class="row">
        <div class="col">
            <div class="text-left">
                <a href="{{ route('admin.subdistrict') }}" class="btn btn-secondary"><i class="fas fa-angle-double-left"></i> {{ __('ย้อนกลับ')   }}</a>
                <hr>
            </div>
