...
@section('titlepage', 'รายละเอียดแผนงาน')
        ...
        <div class="col">
            ...
            <table class="table table-hover table-bordered table-striped">
                ...
                <tbody class="bg-white">
                    ...
                    <tr>
                        <td class="tb-td text-left col-12 col-lg-2">{{ $detail->foodsample->name }}</td>
                        ...
                        <td class="tb-td text-center col-12 col-lg-2">
                            ...
                            <span class="badge badge-success pl-3 pr-3">{{ __('ไม่พบ') }}</span>
                            @elseif($detail->inspection_result == '2')
                            <span class="badge badge-warning pl-3 pr-3">{{ __('พบปลอดภัย') }}</span>
                            @elseif($detail->inspection_result == '3')
                            <span class="badge badge-danger pl-3 pr-3">{{ __('พบไม่ปลอดภัย') }}</span>
                            @endif
                        </td>
                        <td class="tb-td text-left col-12 col-lg-2">{{ $detail->actuation_after ?? 'ไม่มีหมายเหตุ' }}</td>
                    </tr>
                    @empty
                    <tr>
