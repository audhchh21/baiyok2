...
<div class="main-content-container container-fluid px-4">
    ...
    <div class="row mb-5">
        <div class="col">
            ...
            @endif
            <a href="{{ route('pdf.plan.slowsuccess') }}" class="btn btn-sm btn-dark" target="_blank" data-toggle="tooltip" data-placement="right" title="ออกรายงาน PDF"><i class="fas fa-file-pdf pr-2"></i>{{ __('PDF') }}</a>
